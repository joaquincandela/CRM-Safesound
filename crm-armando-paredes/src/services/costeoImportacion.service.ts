...
import type { CrearCosteoInput, ActualizarCosteoInput } from "../validators/costeoImportacion.validator.js";
...
export async function crearCosteo(data: CrearCosteoInput, usuarioId: string) {
  return prisma.$transaction(async (tx) => {
    ...
    if (existente) throw Conflict("La recepción ya tiene un costeo de importación");
